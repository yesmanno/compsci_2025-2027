...
If you paste one or two more functions you expect to see (like 2D list averaging, stack/queue ops), I can do the same **step-by-step Big-O** breakdown for each in the exact cheat-sheet format.
